...
ggplot(combined_df_fin, aes(x = model, y = row_name, 
  ...
  facet_grid(group~model*list_name, scales = "free_y", space = "free_y", switch = "both") + 
  geom_text(aes(label = ifelse(!is.na(coef), round(coef,2), "")), 
  ...
  theme(axis.text=element_text(size=11), 
        ...
        legend.margin=margin(t=0.1, r=0.1, b=0.1, l=0.1),
        ...
        strip.text.x = element_text(angle = 65, margin = margin(0, 0, -15, 0)),
